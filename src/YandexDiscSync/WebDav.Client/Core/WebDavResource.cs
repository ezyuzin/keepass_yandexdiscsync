...
namespace WebDav
{
    ...
    public class WebDavResource
    {
        ...
        /// </summary>
        public List<ActiveLock> ActiveLocks { get; private set; }
        ...
        /// </summary>
        public List<WebDavProperty> Properties { get; private set; }

        /// <summary>
        /// Gets the collection of property statuses of this resource.
        /// </summary>
        public List<WebDavPropertyStatus> PropertyStatuses { get; private set; }
        ...
        public class Builder
        {
            ...
            private List<WebDavProperty> _properties;
            private List<WebDavPropertyStatus> _propertyStatuses;

            /// <summary>
            /// Sets the ActiveLocks parameter of an instance of the <see cref="WebDavResource"/> class.
            /// </summary>
            public Builder WithActiveLocks(List<ActiveLock> activeLocks)
            {
            ...
            /// </summary>
            public Builder WithProperties(List<WebDavProperty> properties)
            {
            ...
            /// </summary>
            public Builder WithPropertyStatuses(List<WebDavPropertyStatus> propertyStatuses)
            {
